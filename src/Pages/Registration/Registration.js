...
//          {(!isValidString(name)) ? <p style={{ color: "red", height: ".6rem" }}>{message}</p> : <span></span>}
//           {toggle ? (
//             <>
...
//             {toggle ? (
//               <h6 style={{display:"flex",justifyContent:"end"}}> UseEmail insted </h6>
//             ) : (
//               <h6 style={{display:"flex",justifyContent:"end"}}>UsePhone insted</h6>
//             )}
